...
async function connectDB() {
  ...
  try {
    ...
    await Streamer.collection.dropIndex('user_1').catch(() => {});
    await Streamer.syncIndexes().catch((err) =>
      logger.warn('Não foi possível sincronizar índices de Streamer:', err.message)
    );
